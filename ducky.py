...
def initial_mode_keyboard(game_key: str, bet: float) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("Double (rounds x2)", callback_data=f"imode_{game_key}_{bet_str}_double")],
    ])
...
def crazy_mode_keyboard(game_key: str, bet: float, rounds: int, rolls: int) -> InlineKeyboardMarkup:
    ...
    Double mode: high wins, but the chosen round count is doubled.
    """
    bet_str = f"{bet:.2f}"
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(f"Double (rounds x2 \u2192 {rounds*2})", callback_data=f"rules_{game_key}_{bet_str}_{rounds}_{rolls}_double")],
    ])
...
async def oppsel_callback(
    ...
    effective_rounds = rounds * 2 if mode == "double" else rounds
