...
# Slots Mini App URL (NightWager WebApp)
...
async def start_command(
    ...
    """Handle /start or /menu - show NightWager main menu."""
    user = update.effective_user
    chat_id = update.effective_chat.id
    bal = store.get_balance(user.id)
    msg = await update.message.reply_text(
        f"\U0001f44b Welcome to NightWager, {user.first_name}.\n\n"
...
async def button_callback(
    ...
    # ---- Individual Game Buttons ----
        ...
        await query.edit_message_text(
            "\U0001f3b2 NightWager \u2014 Dice\n\n"
            "Usage: /dice@NightWagerMain bet\n\n"
            "Example: /dice@NightWagerMain 10",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
        ...
        await query.edit_message_text(
            "\U0001f3b3 NightWager \u2014 Bowling\n\n"
            "Usage: /bowl@NightWagerMain bet\n\n"
            "Example: /bowl@NightWagerMain 10",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
        ...
        await query.edit_message_text(
            "\u26bd NightWager \u2014 Soccer\n\n"
            "Usage: /football@NightWagerMain bet\n\n"
            "Example: /football@NightWagerMain 10",
            reply_markup=back_to_menu_keyboard(),
        )

    elif data == "game_darts":
        await query.edit_message_text(
            "\U0001f3af NightWager \u2014 Darts\n\n"
            "Usage: /darts@NightWagerMain bet\n\n"
            "Example: /darts@NightWagerMain 10",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
        ...
        await query.edit_message_text(
            "\U0001f3c0 NightWager \u2014 Basketball\n\n"
            "Usage: /ball@NightWagerMain bet\n\n"
            "Example: /ball@NightWagerMain 10",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
        ...
        await query.edit_message_text(
            "\U0001f0cf NightWager \u2014 Blackjack\n\n"
            "Usage: /blackjack bet\n\n"
    ...
    # ---- Bonus menu ----
        ...
        await query.edit_message_text(
            ...
            "<i>Add -@NightWagerMain To Your Name To Get Your Bonuses Boosted.</i>",
    ...
    # ---- House Balance ----
        ...
        await query.edit_message_text(
            f"\U0001f3e6 NightWager \u2014 House Balance\n\n"
            f"  ${house_bal:.2f}",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
...
async def rounds_selection_callback(
    ...
    await query.edit_message_text(
        f"NightWager \u2022 {game_type.value.title()}\n\n"
        f"Bet: ${bet:.2f}\n"
        ...
        try:
            ...
            if payment_status in ("paid", "manual_accept"):
                ...
                msg = await context.bot.send_message(
                    chat_id=chat_id,
                    text=(
                        f"\u2705 NightWager \u2014 Deposit Confirmed!\n\n"
                        f"{received_line}"
...
async def _execute_withdrawal(
    ...
    try:
        result = await oxapay.create_payout(
            ...
            currency=currency,
            amount=net_amount,
            description=f"NightWager withdrawal for user {user.id} (5% fee applied)",
        )
        ...
        msg = await reply_target.reply_text(
            f"\u2705 NightWager \u2014 Withdrawal Submitted\n\n"
...
async def tip_command(
    ...
    msg = await message.reply_text(
        f"\U0001f4b8 NightWager \u2014 Tip Sent!\n\n"
...
def _build_weekly_text(info: Dict[str, Any]) -> str:
    if info["can_claim"]:
        return (
            ...
            f"<i>Add -@NightWagerMain To Your Name To Get Your Bonuses Boosted.</i>"
        )
    return (
        f"\U0001f4c5 Weekly Bonus\n\n"
...
# ---------------------------------------------------------------------------
# Slots Mini App (NightWager)
# ---------------------------------------------------------------------------

async def slots_command(
    update: Update, context: ContextTypes.DEFAULT_TYPE
) -> None:
    """Handle /slots - open the NightWager slots mini app."""
    user = update.effective_user
    bal = store.get_balance(user.id)
...
async def slots_webapp_data_handler(
    ...
    """Handle data returned from the NightWager slots mini app."""
    user = update.effective_user
...
def bj_render_table(session: BlackjackSession, reveal_dealer: bool = False) -> str:
    ...
    lines = ["\U0001f0cf NightWager \u2014 Blackjack\n"]
...
async def tower_command(
    ...
    if difficulty is None:
        ...
        m = await update.message.reply_text(
            f"\U0001f435 NightWager \u2014 Monkey Tower\n\n"
            f"Bet: ${bet:.2f}\n\n"
...
def main() -> None:
    ...
    logger.info("\u2620\ufe0f NightWager Bot is starting...")
    logger.info(
