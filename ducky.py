...
WINS_GROUP_ID = int(os.getenv("WINS_GROUP_ID", "-1003682941498"))
...
def main() -> None:
    ...
    # Expose the bot + main loop to sync code so win notifications can be posted to WINS_GROUP_ID.
    ...
    async def _capture_loop(_app):
        ...
        try:
            chat = await app.bot.get_chat(WINS_GROUP_ID)
