...
def _install_bold_all(app) -> None:
    ...
    Defaults parse_mode is forced to HTML, and the bot's send/edit text methods
    are patched to wrap the message text in <b>...</b>.
    """
    def _bold(t):
        if t is None:
            return t
    ...
    object.__setattr__(app.bot, "send_message", _wrap(app.bot.send_message, "text"))
    object.__setattr__(app.bot, "edit_message_text", _wrap(app.bot.edit_message_text, "text"))
    object.__setattr__(app.bot, "send_photo", _wrap(app.bot.send_photo, "caption"))
    object.__setattr__(app.bot, "edit_message_caption", _wrap(app.bot.edit_message_caption, "caption"))
