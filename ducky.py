...
class BalanceStore:
    ...
    def _load(self) -> None:
        # Persistence: load balances, stats, and house profit from disk on startup.
        # No more startup reset — data carries across restarts.
        pass
...
async def start_command(
    ...
    """Handle /start or /menu - show DuckyCasino main menu."""
...
async def button_callback(
    ...
    # ---- Deposit (menu button) ----
        ...
        await query.edit_message_text(
            "<b>\U0001f4b3 DuckyCasino \u2014 Deposit</b>\n\n"
    ...
    # ---- Withdraw ----
        ...
        await query.edit_message_text(
            "<b>\U0001f4b8 DuckyCasino \u2014 Withdraw</b>\n\n"
    ...
    # ---- Individual Game Buttons ----
        ...
        await query.edit_message_text(
            "<b>\U0001f3b2 DuckyCasino \u2014 Dice</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f3b3 DuckyCasino \u2014 Bowling</b>\n\n"
            "Send your bet to start:\n"
            "  /bowl <amount>\n\n"
            "Example: /bowl 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f3af DuckyCasino \u2014 Darts</b>\n\n"
            "Send your bet to start:\n"
            "  /darts <amount>\n\n"
            "Example: /darts 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f3c0 DuckyCasino \u2014 Basketball</b>\n\n"
            "Send your bet to start:\n"
            "  /ball <amount>\n\n"
            "Example: /ball 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f0cf DuckyCasino \u2014 Blackjack</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f4a3 DuckyCasino \u2014 Mines</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f435 DuckyCasino \u2014 Monkey Tower</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001fa99 DuckyCasino \u2014 Coinflip</b>\n\n"
            "Call heads or tails!\n\n"
            "  /heads <amount>\n"
            "  /tails <amount>\n\n"
            "Example: /heads 10\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f3b0 Ducky Casino \u2014 Slots</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f680 DuckyCasino \u2014 Limbo</b>\n\n"
    ...
    # ---- Stats ----
        ...
        await query.edit_message_text(
            f"<b>\U0001f4ca DuckyCasino \u2014 Your Stats</b>\n\n"
    ...
    # ---- House Balance ----
        ...
        await query.edit_message_text(
            f"<b>\U0001f3e6 DuckyCasino \u2014 House Balance</b>\n\n"
            f"  ${house_bal:.2f}",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
...
async def tip_command(
    ...
    msg = await message.reply_text(
        f"<b>\U0001f4b8 DuckyCasino \u2014 Tip Sent!</b>\n\n"
...
async def slots_command(
    ...
    m = await update.message.reply_text(
        f"<b>\U0001f3b0 **Ducky Casino** \u2014 Slots</b>\n\n"
        f"Your balance: ${bal:.2f}\n\n"
...
def _mines_header(session: dict) -> str:
    ...
    return (
        f"<b>\U0001f4a3 DuckyCasino \u2014 Mines</b>\n\n"
        f"\U0001f4b5 Bet: ${bet:.2f}\n"
...
def _tower_header(session: dict) -> str:
    ...
    if current_row > 0:
        ...
        payout = 0
    return (
        f"<b>\U0001f435 DuckyCasino \u2014 Monkey Tower</b>\n\n"
