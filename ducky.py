...
async def button_callback(
    ...
    # ---- Deposit (menu button) ----
        ...
        await query.edit_message_text(
            "<b>\U0001f4b3 The Dice Room \u2014 Deposit</b>\n\n"
    ...
    # ---- Withdraw ----
        ...
        rows.append([InlineKeyboardButton("\u00ab Back to Menu", callback_data="menu_main")])
        await query.edit_message_text(
            "<b>\U0001f4b8 The Dice Room \u2014 Withdraw</b>\n\n"
    ...
    # ---- Games Menu ----
        ...
        await query.edit_message_text(
            "<b>\U0001f3ae DuckyCasino \u2014 Games</b>\n\n"
    ...
    # ---- Individual Game Buttons ----
        ...
        await query.edit_message_text(
            "<b>\U0001f3b2 The Dice Room \u2014 Dice</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f3b3 The Dice Room \u2014 Bowling</b>\n\n"
            "Send your bet to start:\n"
            "  /bowl &lt;amount&gt;\n\n"
            "Example: /bowl 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f3af The Dice Room \u2014 Darts</b>\n\n"
            "Send your bet to start:\n"
            "  /darts &lt;amount&gt;\n\n"
            "Example: /darts 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f3c0 The Dice Room \u2014 Basketball</b>\n\n"
            "Send your bet to start:\n"
            "  /ball &lt;amount&gt;\n\n"
            "Example: /ball 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "<b>\U0001f0cf The Dice Room \u2014 Blackjack</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f4a3 The Dice Room \u2014 Mines</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001fa9c The Dice Room \u2014 Tower</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001fa99 The Dice Room \u2014 Coinflip</b>\n\n"
            "Call heads or tails!\n\n"
            "  /heads &lt;amount&gt;\n"
            "  /tails &lt;amount&gt;\n\n"
            "Example: /heads 10\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f3b0 The Dice Room \u2014 Slots</b>\n\n"
        ...
        await query.edit_message_text(
            "<b>\U0001f680 The Dice Room \u2014 Limbo</b>\n\n"
    ...
    # ---- Stats ----
        ...
        await query.edit_message_text(
            f"<b>\U0001f4ca The Dice Room \u2014 Your Stats</b>\n\n"
    ...
    # ---- House Balance ----
        ...
        await query.edit_message_text(
            f"<b>\U0001f3e6 The Dice Room \u2014 House Balance</b>\n\n"
            f"  ${house_bal:.2f}",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
    ...
    # ---- Claim Weekly Bonus ----
        ...
        if bonus > 0:
            text = (
                f"<b>\U0001f389 Weekly Bonus Claimed!</b>\n\n"
                f"\U0001f3b0 Wagered this week: ${wagered:,.2f}\n"
                f"\U0001f4b5 Bonus (1.50%): ${bonus:,.2f}\n\n"
    ...
    # ---- Claim Monthly Bonus ----
        ...
        if bonus > 0:
            text = (
                f"<b>\U0001f389 Monthly Bonus Claimed!</b>\n\n"
...
async def withdraw_coin_callback(
    ...
    await query.edit_message_text(
        f"<b>\U0001f4b8 Withdraw {currency}</b>\n\n"
...
async def withdraw_text_handler(
    ...
    if step == "amount":
        ...
        state["step"] = "address"
        await update.message.reply_text(
            f"\u2705 Amount: <b>${amount:.2f}</b> in <b>{currency}</b>\n\n"
            f"Now send your <b>{currency}</b> wallet address.\n\n"
            f"Type /cancel to abort.",
            parse_mode="HTML",
        )
        return
...
async def tip_command(
    ...
    if not message.reply_to_message:
        msg = await message.reply_text(
            "<b>\U0001f4b8 The Dice Room \u2014 Tip</b>\n\n"
    ...
    msg = await message.reply_text(
        f"<b>\U0001f4b8 The Dice Room \u2014 Tip Sent!</b>\n\n"
...
def _build_weekly_text(info: Dict[str, Any]) -> str:
    if info["can_claim"]:
        return (
            f"<b>\U0001f389 Weekly Bonus Ready!</b>\n\n"
            f"\U0001f3b0 Wagered this week: ${info['wagered']:,.2f}\n"
            f"\U0001f4b5 Bonus (1.50%): ${info['potential_bonus']:,.2f}\n\n"
            f"Tap below to claim your bonus!"
        )
    return (
        f"<b>\U0001f4c5 Weekly Bonus</b>\n\n"
        f"\u23f3 Unlocks in: <b>{_format_countdown(info['seconds_remaining'])}</b>\n"
        f"\U0001f4c5 Exact time: {_format_unlock_time(info['next_claim_ts'])}\n\n"
        f"\U0001f3b0 Wagered this week: ${info['wagered']:,.2f}\n"
        f"\U0001f4b0 Current bonus (1.50%): ${info['potential_bonus']:,.2f}\n\n"
...
def _build_monthly_text(info: Dict[str, Any]) -> str:
    if info["can_claim"]:
        return (
            f"<b>\U0001f389 Monthly Bonus Ready!</b>\n\n"
...
async def leaderboard_command(
    ...
    text = (
        ...
        "<b>\U0001f4b0 Top 10 by Total Wagered</b>\n\n"
        + "\n".join(lines)
    )
...
async def slots_command(
    ...
    m = await update.message.reply_text(
        f"<b>\U0001f3b0 **The Dice Room** \u2014 Slots</b>\n\n"
        f"Your balance: ${bal:.2f}\n\n"
...
async def dr_command(
    ...
    if prediction is not None or picked_numbers:
        ...
        await update.message.reply_text(
            f"<b>\U0001f3b0 Dice Roulette \u2014 ${bet:.2f}</b>\n\n"
...
async def tournament_announcement_job(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    msg = await context.bot.send_message(
        ...
        text=(
            "<b>\U0001f3c6 Weekly Tournament!</b>\n\n"
...
async def tournament_join_callback(
    ...
    try:
        await query.edit_message_text(
            f"<b>\U0001f3c6 Weekly Tournament!</b>\n\n"
...
def _preopen_announcement_text() -> str:
    ...
    return (
        "<b>\U0001f3b2 Pre-Opening Dice Tournament! \U0001f3c6</b>\n\n"
...
def _mines_header(session: dict) -> str:
    ...
    return (
        f"<b>\U0001f4a3 The Dice Room \u2014 Mines</b>\n\n"
        f"\U0001f4b5 Bet: ${bet:.2f}\n"
...
def _tower_header(session: dict) -> str:
    ...
    if current_row > 0:
        ...
        payout = 0
    return (
        f"<b>\U0001fa9c The Dice Room \u2014 Tower</b>\n\n"
...
async def tower_command(
    ...
    if difficulty is None:
        ...
        m = await update.message.reply_text(
            f"<b>\U0001f435 The Dice Room \u2014 Monkey Tower</b>\n\n"
            f"\U0001f4b5 Bet: ${bet:.2f}\n\n"
...
async def coinflip_command(
    ...
    await context.bot.send_animation(
        ...
        animation=flip_gif,
        caption=(
            f"<b>\U0001fa99 Coinflip \u2014 ${bet:.2f}</b>\n\n"
...
async def quick_bet_open_callback(
    ...
    await query.answer()
    await query.edit_message_text(
        f"<b>\U0001f3b0 {label} \u2014 pick a bet</b>\n\n"
        f"\U0001f4b0 Balance: ${bal:.2f}\n"
