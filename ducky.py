...
def _install_bold_all(app) -> None:
    ...
    app.bot.send_message = _wrap(app.bot.send_message, "text")
    app.bot.edit_message_text = _wrap(app.bot.edit_message_text, "text")
    app.bot.send_photo = _wrap(app.bot.send_photo, "caption")
    app.bot.edit_message_caption = _wrap(app.bot.edit_message_caption, "caption")
