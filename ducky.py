...
def cashout_keyboard(
    ...
    label = f"\U0001f4b0 Cash Out ${payout:.2f} ({multi:g}x)"
    return InlineKeyboardMarkup([
...
async def start_command(
    ...
    msg = await update.message.reply_text(
        f"\U0001f44b <b>Welcome to The Dice Room, {user.first_name}.</b>\n\n"
...
async def balance_command(
    ...
    bal = store.get_balance(user.id)
    msg = await update.message.reply_text(
        f"\U0001f4b0 <b>Your balance: ${bal:.2f}</b>",
        parse_mode="HTML",
    )
    _record_owner(chat_id, msg.message_id, user.id)
...
async def button_callback(
    ...
    # ---- Deposit (menu button) ----
        ...
        await query.edit_message_text(
            "\U0001f4b3 <b>The Dice Room \u2014 Deposit</b>\n\n"
    ...
    # ---- Withdraw ----
        ...
        rows.append([InlineKeyboardButton("\u00ab Back to Menu", callback_data="menu_main")])
        await query.edit_message_text(
            "\U0001f4b8 <b>The Dice Room \u2014 Withdraw</b>\n\n"
    ...
    # ---- Individual Game Buttons ----
        ...
        await query.edit_message_text(
            "\U0001f3b2 <b>The Dice Room \u2014 Dice</b>\n\n"
        ...
        await query.edit_message_text(
            "\U0001f3b3 <b>The Dice Room \u2014 Bowling</b>\n\n"
            "Send your bet to start:\n"
            "  /bowl &lt;amount&gt;\n\n"
            "Example: /bowl 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "\U0001f3af <b>The Dice Room \u2014 Darts</b>\n\n"
            "Send your bet to start:\n"
            "  /darts &lt;amount&gt;\n\n"
            "Example: /darts 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "\U0001f3c0 <b>The Dice Room \u2014 Basketball</b>\n\n"
            "Send your bet to start:\n"
            "  /ball &lt;amount&gt;\n\n"
            "Example: /ball 10",
            reply_markup=back_to_menu_keyboard(),
        ...
        await query.edit_message_text(
            "\U0001f0cf <b>The Dice Room \u2014 Blackjack</b>\n\n"
        ...
        await query.edit_message_text(
            "\U0001f4a3 <b>The Dice Room \u2014 Mines</b>\n\n"
        ...
        await query.edit_message_text(
            "\U0001fa9c <b>The Dice Room \u2014 Tower</b>\n\n"
            "Climb 8 rows! Each row has 3 columns \u2014\n"
            "1 safe step and 2 traps.\n\n"
            "Send your bet to start:\n"
            "  /tower &lt;amount&gt;\n\n"
            "Example: /tower 10\n"
        ...
        await query.edit_message_text(
            "\U0001fa99 <b>The Dice Room \u2014 Coinflip</b>\n\n"
            "Call heads or tails!\n\n"
            "  /heads &lt;amount&gt;\n"
            "  /tails &lt;amount&gt;\n\n"
            "Example: /heads 10\n"
        ...
        await query.edit_message_text(
            "\U0001f3b0 <b>The Dice Room \u2014 Slots</b>\n\n"
        ...
        await query.edit_message_text(
            "\U0001f680 <b>The Dice Room \u2014 Limbo</b>\n\n"
            "Pick a target multiplier. If the rolled result is at or above your "
            "target, you win!\n\n"
            "  /limbo &lt;bet&gt; &lt;target multiplier&gt;\n\n"
            "Example: /limbo 1 2.5\n"
            "Higher target = higher payout, lower chance.",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
    ...
    # ---- Stats ----
        ...
        await query.edit_message_text(
            f"\U0001f4ca <b>The Dice Room \u2014 Your Stats</b>\n\n"
            ...
            f"  \U0001f3b0 Total Wagered: ${stats['total_wagered']:.2f}\n"
    ...
    # ---- House Balance ----
        ...
        await query.edit_message_text(
            f"\U0001f3e6 <b>The Dice Room \u2014 House Balance</b>\n\n"
            f"  ${house_bal:.2f}",
            reply_markup=back_to_menu_keyboard(),
            parse_mode="HTML",
        )
    ...
    # ---- Claim Weekly Bonus ----
        ...
        if bonus > 0:
            text = (
                f"\U0001f389 <b>Weekly Bonus Claimed!</b>\n\n"
    ...
    # ---- Claim Monthly Bonus ----
        ...
        if bonus > 0:
            text = (
                f"\U0001f389 <b>Monthly Bonus Claimed!</b>\n\n"
    ...
    # ---- Claim Weekly Leaderboard Bonus ----
        ...
        new_bal = store.get_balance(user.id)
        await query.edit_message_text(
            f"\U0001f389 <b>Leaderboard Bonus Claimed!</b>\n\n"
...
async def rounds_selection_callback(
    ...
    await query.edit_message_text(
        f"\u2620\ufe0f <b>The Dice Room \u2014 {game_type.value.title()}</b>\n\n"
        ...
        try:
            ...
            if payment_status in ("paid", "manual_accept"):
                ...
                msg = await context.bot.send_message(
                    chat_id=chat_id,
                    text=(
                        f"\u2705 <b>The Dice Room \u2014 Deposit Confirmed!</b>\n\n"
                        f"{received_line}"
...
async def withdraw_coin_callback(
    ...
    await query.edit_message_text(
        f"\U0001f4b8 <b>Withdraw {currency}</b>\n\n"
        f"Your balance: ${bal:.2f}\n\n"
...
async def _execute_withdrawal(
    ...
    try:
        ...
        msg = await reply_target.reply_text(
            f"\u2705 <b>The Dice Room \u2014 Withdrawal Submitted</b>\n\n"
...
async def tip_command(
    ...
    if not message.reply_to_message:
        msg = await message.reply_text(
            "\U0001f4b8 <b>The Dice Room \u2014 Tip</b>\n\n"
    ...
    msg = await message.reply_text(
        f"\U0001f4b8 <b>The Dice Room \u2014 Tip Sent!</b>\n\n"
...
async def stats_command(
    ...
    text = (
        ...
        f"\U0001f3b0 Total Wagered: ${user_stats['total_wagered']:,.2f}\n\n"
        f"{net_emoji} Net Profit/Loss: {net_sign}${abs(net):,.2f}"
    )
...
def _build_weekly_text(info: Dict[str, Any]) -> str:
    if info["can_claim"]:
        return (
            f"\U0001f389 <b>Weekly Bonus Ready!</b>\n\n"
...
def _build_monthly_text(info: Dict[str, Any]) -> str:
    if info["can_claim"]:
        return (
            f"\U0001f389 <b>Monthly Bonus Ready!</b>\n\n"
...
async def leaderboard_command(
    ...
    text = (
        "\U0001f3c6 <b>The Dice Room Leaderboard</b>\n"
...
async def tournament_announcement_job(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    msg = await context.bot.send_message(
        ...
        text=(
            "\U0001f3c6 <b>Weekly Tournament!</b>\n\n"
...
async def tournament_join_callback(
    ...
    try:
        await query.edit_message_text(
            f"\U0001f3c6 <b>Weekly Tournament!</b>\n\n"
...
async def _tournament_award_prizes(
    ...
    results = "\U0001f3c6 <b>Tournament Results!</b>\n\n"
...
def _preopen_announcement_text() -> str:
    ...
    return (
        "\U0001f3b2 <b>Pre-Opening Dice Tournament!</b> \U0001f3c6\n\n"
...
async def _preopen_run_job(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await context.bot.send_message(
        chat_id=chat_id,
        text=(
            f"\U0001f3c6 <b>Pre-Opening Tournament Starting!</b>\n"
...
def _mines_header(session: dict) -> str:
    ...
    return (
        f"\U0001f4a3 <b>The Dice Room \u2014 Mines</b>\n\n"
        f"\U0001f4b5 Bet: ${bet:.2f}\n"
...
def _tower_header(session: dict) -> str:
    ...
    if current_row > 0:
        ...
        payout = 0
    return (
        f"\U0001fa9c <b>The Dice Room \u2014 Tower</b>\n\n"
...
async def tower_command(
    ...
    if difficulty is None:
        ...
        m = await update.message.reply_text(
            f"\U0001f435 <b>The Dice Room \u2014 Monkey Tower</b>\n\n"
            f"\U0001f4b5 Bet: ${bet:.2f}\n\n"
