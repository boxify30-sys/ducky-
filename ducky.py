...
async def withdraw_command(
    ...
    # Require lifetime deposits >= MIN_DEPOSITED_TO_WITHDRAW (owner is exempt).
    # Rain/tip/bonus credits are not withdrawable until the user has deposited
    # at least this much in total.
    if user.id != OWNER_ID:
