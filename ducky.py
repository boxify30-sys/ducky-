...
async def _send_win_to_group(user_id: int, user_name: str, game: str, bet: float, payout: float) -> None:
    ...
    try:
        ...
        logger.error("Failed to send wins group notification: %s", e)
...
def _schedule_win_notification(user_id: int, user_name: str, game: str, bet: float, payout: float) -> None:
    ...
    try:
        ...
        return
    loop.create_task(_send_win_to_group(user_id, user_name, game, bet, payout))
...
def main() -> None:
    ...
    global _wins_bot
    _wins_bot = app.bot
    logger.info("Wins group notifications: WINS_GROUP_ID=%s", WINS_GROUP_ID)
